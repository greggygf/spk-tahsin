...
public class AlMunawaroh extends AppCompatActivity {

    // Get a reference to our posts
    final FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference ref = database.getReference("rank").child("al-munawaroh").child("alternatif");
    ...
    public void onClickListData(View view) {
        Intent i = new Intent(AlMunawaroh.this, EditDataActivity.class);
        startActivity(i);
    }
